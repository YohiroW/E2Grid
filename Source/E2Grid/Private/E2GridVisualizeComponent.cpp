...
void UE2GridVisualizeComponent::BuildGridInstancedMeshes()
{
	...
	GridOwner->ForEachCell(
		[this, &LocalScale](int32, const FE2GridCellData&, const FVector& WorldPosition)
		{
			const FTransform InstanceTransform(
				FQuat::Identity,
				GetComponentTransform().InverseTransformPosition(WorldPosition),
				LocalScale);
